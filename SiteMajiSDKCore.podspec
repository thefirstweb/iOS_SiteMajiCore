#
#  Be sure to run `pod spec lint SiteMajiSDKCore.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/thefirstweb/iOS_SiteMajiCore"
  ...
  s.author             = { "ck00031" => "alexwang@sitetag.us" }
  # Or just: s.author    = "Alex Wang"
  # s.authors            = { "Alex Wang" => "ck00031@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Alex Wang"
  ...
  s.source       = { :git => "https://github.com/thefirstweb/iOS_SiteMajiCore.git", :tag => "#{s.version}" }
